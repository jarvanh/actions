...
# ────────────────────────────────────────────────────────────
sec "13 · 大文件落盘阶梯（原用于定位「重传但未落盘」长尾；该长尾已于 2026-09-15 收口）"
# 背景（2026-09-15 生产取证，C 判据当时未达标的直接原因；已于同日收口，见计划文档 §12.9）:
#   run 34940234180 日志:
...
#      （已由修复尾段预留 OPENLIST_REPAIR_RESERVE_PCT 打破，见计划文档 §12.9。）
